...
- El cierre de 3D.4 no abrió por sí mismo ninguna subfase. Tras evaluar las candidatas,
  ...
  *runner de prueba* (comparación de `version` bigint devuelta como string
  ...
  `approve()`). B4.F queda CERRADA posteriormente el 06/09/2026 — PASS REAL. B5 fue ABIERTA después el 06/09/2026; B5.1 queda CERRADA OFFLINE; B5.2 queda CERRADA OFFLINE — wiring productivo preparado pero no activado — y B5.3/B6 siguen NO ABIERTAS. Mission Queue
  no tocada.
...
16. **Conservar la sonda de 3D.6** en
    ...
    **BLOQUEADA/DEFERIDA**), restore (sigue **DIFERIDO**) ni 3D.5/3E (cerradas/no
    ...
    wiring productivo ni concurrencia adicional más allá de B4.D.2); B4.F CERRADA posteriormente el 06/09/2026 — PASS REAL; B5 ABIERTA posteriormente el 06/09/2026, con B5.1 CERRADA OFFLINE y B5.2 CERRADA OFFLINE — wiring productivo preparado pero no activado —; B5.3 y B6 no abiertas —
